namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_c6e1f41UsrRealty1MethodsWrapper

	/// <exclude/>
	public class UsrProcess_c6e1f41UsrRealty1MethodsWrapper : ProcessModel
	{

		public UsrProcess_c6e1f41UsrRealty1MethodsWrapper(Process process)
			: base(process) {
