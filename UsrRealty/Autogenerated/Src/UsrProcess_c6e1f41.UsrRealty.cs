namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_c6e1f41MethodsWrapper

	/// <exclude/>
	public class UsrProcess_c6e1f41MethodsWrapper : ProcessModel
	{

		public UsrProcess_c6e1f41MethodsWrapper(Process process)
			: base(process) {
